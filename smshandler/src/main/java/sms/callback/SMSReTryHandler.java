 ...
 *
 */
public class SMSReTryHandler extends HttpServlet {
	private static final long serialVersionUID = 1L;

	private static final String AERFRAME_API_URL = "<API URL>";
	private static final String API_KEY = "API Key";
	private static final String ACC_NUMBER = "<account number>";
...
//		}
	...
	private static void sendMsgToAerFrame(final String accountNumber, final String appName, final String toNumber,
		...
		try {
			...
			/**
			 * retry mechanism needs to be in place based on http failed status code 
			 */
	...
	private static String getIMSIFromNumber(final String toNumber) {
		/**
		 * being a dev account, we can not have mapping between msisdn & imsi. this should be done from database
		 */
		return "<imsi no>";
	}
